...
import { CatchFoodGameEventMessage, CATCH_FOOD_GAME_EVENT_MESSAGES, CATCH_FOOD_GAME_EVENT_MESSAGE__APPROACHING_SKIPPABLE_OBSTACLE, CATCH_FOOD_GAME_EVENT_MESSAGE__CHASERS_WERE_PUSHED, CATCH_FOOD_GAME_EVENT_MESSAGE__INITIAL_GAME_STATE_INFO_UPDATE, CATCH_FOOD_GAME_EVENT_MESSAGE__OBSTACLE_REACHED, CATCH_FOOD_GAME_EVENT_MESSAGE__PLAYER_HAS_FINISHED, CATCH_FOOD_GAME_EVENT_MESSAGE__PLAYER_IS_DEAD, CATCH_FOOD_GAME_EVENT_MESSAGE__PLAYER_IS_STUNNED, CATCH_FOOD_GAME_EVENT_MESSAGE__PLAYER_IS_UNSTUNNED } from "./interfaces/CatchFoodGameEventMessages";
...
export class CatchFoodGameEventMessageEmitter implements EventMessageEmitter {
    ...
    handle(controllerNameSpace: Namespace, screenNameSpace: Namespace, room: Room, message: CatchFoodGameEventMessage): void {
        ...
        switch (message.type) {
            ...
            case CATCH_FOOD_GAME_EVENT_MESSAGE__APPROACHING_SKIPPABLE_OBSTACLE:
