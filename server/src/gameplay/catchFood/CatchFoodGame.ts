...
import { createObstacles, getObstacleTypes, getStonesForObstacles, sortBy } from './helperFunctions/initiatePlayerState';
...
export default class CatchFoodGame extends Game<CatchFoodPlayer, GameStateInfo> implements CatchFoodGameInterface {
    ...
    protected postProcessPlayers(playersIterable: IterableIterator<CatchFoodPlayer>) {
        ...
        const stones = getStonesForObstacles(obstacles, this.trackLength, this.initialPlayerPositionX, 100, this.numberOfStones);
