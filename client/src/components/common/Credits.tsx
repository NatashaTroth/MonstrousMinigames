        ...
        <ContentContainer>
            <ContentWrapper>
                ...
                <TextContainer>
                    ...
                    <Headline>Interpretation and Definitions Interpretation</Headline>
                    ...
                    <ul>
                        <li>
                            ...
                            refers to Monstrous Mini Games.
                        </li>
                        <li>
                            <b>Country</b> refers to: Austria
                        </li>
                        <li>
                        ...
                        <li>
                            <b>Website</b> refers to Monstrous Mini Games, accessible from
                            https://monstrous-minigames.web.app/
                        </li>
                        <li>
                    ...
                    <Headline>Collecting and Using Your Personal</Headline>
                    <SubHeading>Data Types of Data Collected</SubHeading>
                    <b>Personal Data</b>
                    <br />
                    ...
                    <ul>
                        <li>First name</li>
                        <li>Usage Data</li>
                        <li>Images you upload within the scope of use</li>
                    </ul>
                    <b>Usage Data</b>
                    <br />
                    ...
                    the pages of our Service that You visit, unique device identifiers and other diagnostic data. When
                    You access the Service by or through a mobile device, We may collect certain information
                    automatically, including, but not limited to, the type of mobile device You use, Your mobile device
                    unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile
                    Internet browser You use, unique device identifiers, microphone input, sensor data and other
                    diagnostic data. We may also collect information that Your browser sends whenever You visit our
                    Service or when You access the Service by or through a mobile device.
                    <Headline>Use of Your Personal Data</Headline>
                    ...
                    <Headline>Retention of Your Personal Data</Headline>
                    ...
                    applicable laws), resolve disputes, and enforce our legal agreements and policies. Usage Data is
                    ...
                    <Headline>Transfer of Your Personal Data</Headline>
                    ...
                    information.
                    <Headline>Disclosure of Your Personal Data</Headline>
                    ...
                    <Headline>Security of Your Personal Data</Headline>The security of Your Personal Data is important
                    ...
                    new Privacy Policy on this page. We will update the "Last updated" date at the top of this Privacy
                    ...
                    <ul>
                        <li>office.mmt@fh-salzburg.ac.at</li>
                    </ul>
                </TextContainer>
            </ContentWrapper>
        </ContentContainer>
...
const ContentWrapper = styled(ContentBase)`
    && {
        overflow: scroll;
        align-items: center;
    }
